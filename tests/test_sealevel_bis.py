    ...
    def test_standardize_sealevel(self):
        ...
        for test_case in self.test_cases:
            with self.subTest(test_case=test_case):
                ...
                sea_level_data = pd.read_csv(sea_level_data_path, index_col='date', parse_dates=True)
                ...
                reference_anomalies = pd.read_csv(reference_anomalies_path, index_col='date', parse_dates=True)
