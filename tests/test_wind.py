...
class TestWindComponent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.u10_path = os.path.join(self.temp_dir.name, 'test_u10.nc')
        self.v10_path = os.path.join(self.temp_dir.name, 'test_v10.nc')
        self.mask_path = os.path.join(self.temp_dir.name, 'test_mask.nc')
        self.reference_period = ('2000-01-01', '2009-12-31')

        # Génération des données de vent pour les tests
        ...
        # Initialisation des paramètres pour les données de test
    ...
    def test_std_wind_exceedance_frequency_bis(self):
        """
        Test the std_wind_exceedance_frequency method with different test cases.
        """
        ...
        for test_case in test_cases:
            with self.subTest(test_case=test_case):
                ...
                calculated_anomalies = w_com.std_wind_exceedance_frequency(self.reference_period_bis, area=True)
